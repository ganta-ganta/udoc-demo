...
Message: ${message}`;
    ...
    const whatsappNumber = "917995081439"; // Replace with your WhatsApp number (without "+")
  ...
  window.addEventListener('load', function () {
    ...
    setTimeout(() => {
      loadingText.textContent = 'Please wait, taking some time. Do not leave the page or refresh.';
    }, 5000);
    ...
    }, 10000); // Adjust duration for preloader visibility
  });
